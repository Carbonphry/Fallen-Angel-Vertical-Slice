...
image_speed = .8;
sprite_index = s_lancerangel_executed;

x_ = (x+ random_range(-12,12));
y_ = (y+ random_range(-12,12));
if animation_hit_frame(4)
{
	create_animation_effect(s_red_sparks_effect,x_-10,x_,0.8,true)
	create_animation_effect(s_red_sparks_effect,x_+10,x_,0.8,true)
...
{
	create_animation_effect(s_red_sparks_effect,x_-10,y_,0.8,true)
	create_animation_effect(s_red_sparks_effect,x_+10,y_,0.8,true)

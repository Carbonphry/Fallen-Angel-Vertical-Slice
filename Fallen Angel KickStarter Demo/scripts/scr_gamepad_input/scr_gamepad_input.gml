...
action_three_ = max (gamepad_button_check(argument0,gp_shoulderlb));
action_three_pressed_ = max (gamepad_button_check_pressed(argument0,gp_shoulderlb));
action_three_released_ = max (gamepad_button_check_released(argument0,gp_shoulderlb));
action_four_ = gamepad_button_check(argument0,gp_shoulderr);
action_four_pressed_ = gamepad_button_check_pressed(argument0,gp_shoulderr);
action_four_released_ = gamepad_button_check_released(argument0,gp_shoulderr);
...
action_six_ = gamepad_button_check(argument0,gp_shoulderl);

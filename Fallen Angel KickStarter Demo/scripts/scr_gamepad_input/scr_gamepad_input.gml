...
action_three_ = max (gamepad_button_check(argument0,gp_shoulderlb),gamepad_button_check(argument0,gp_shoulderrb));
action_three_pressed_ = max (gamepad_button_check_pressed(argument0,gp_shoulderlb), gamepad_button_check_pressed(argument0,gp_shoulderrb));
action_three_released_ = max (gamepad_button_check_released(argument0,gp_shoulderlb), gamepad_button_check_released(argument0,gp_shoulderrb));
